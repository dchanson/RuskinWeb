...
<div xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:teix="http://www.tei-c.org/ns/Examples" xmlns:custom="http://whatever" id="content-right">
   ...
   <div class="witness">
      <div class="essay" id="">
         ...
         <div class="p">Most beautiful are the paths which scale the face of the hill which is 
                    <br/>crowned by the <span class="name--HEIDELBERGCASTLE">castle of Heidelberg</span>,<span class="gloss-inline">
          <a href="https://erm.selu.edu/glosses/heidelberg_glosses_contextual#BEAUTIFULPATHS" target="_blank" class="inactive">
              ...
              </a></span> winding beneath the twisted branches 
                    <br/>of green woods, with here and there a grey crag lifting up its lichened 
                    <br/>head from the wilderness of brake<span class="gloss-inline">
         ...
         <div class="p">The <span class="placeName-building-HEIDELBERG">castle of Heidelberg</span> is exceeding desolate. Armies have razed 
                    <br/>its foundations, the thunder hath riven its towers, and there is no sound 
                    <br/>in its courts, and the wind is still in the open galleries.<span class="gloss-inline">
          <a href="https://erm.selu.edu/glosses/heidelberg_glosses_contextual#DESOLATE" target="_blank" class="inactive">
                ...
                4
                    ...
                    <br/>the power of his ancient princes, and knows not if he should grieve that 
                    <br/>their power is past away. I know not how it is, but all nations in all 
                    <br/>ages seem to have respected the juice of the fruit of the vine. All has 
                    <br/>yielded to it from time immemorial. When Marshal Turenne attacked the 
                    <br/>castle in question,<span class="gloss-inline">
          ...
          <a href="https://erm.selu.edu/glosses/heidelberg_glosses_contextual#CELEBRATEDBUTT" target="_blank" class="inactive">
              ...
              </a></span> no rich splash from the enclosed 
                    <br/><i>vinum</i>,<span class="gloss-inline">
